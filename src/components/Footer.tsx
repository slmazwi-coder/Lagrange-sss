    ...
    <footer className="bg-school-green text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="text-2xl font-bold">La-Grange SSS</h3>
            </div>
            <p className="text-white/80 mb-6 italic">"Arise and Shine"</p>
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/pages/Le-Grange-Senior-Secondary-School/182078151881037/"
                target="_blank"
                rel="noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/80">
              <li className="flex items-start gap-3">
                ...
                <span>La-Grange / Mafube, Nkosana A/A, Matatiele, 4730 (Eastern Cape)</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} />
                <span>+27 79 986 8195</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} />
                <span>office@lagrangesss.co.za</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-white/70 text-sm">
          <p>© {new Date().getFullYear()} La-Grange Senior Secondary School. All Rights Reserved.</p>
          <Link
            to="/admin/login"
